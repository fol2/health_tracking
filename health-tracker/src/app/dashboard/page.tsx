    ...
    <DashboardLayout>
      <div className="container mx-auto p-4 space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Link href="/fasting">
            <ActionCard
              ...
              actionLabel={mockData.currentFast ? "View Fast" : "Start Fast"}
              disabled={false}
            />
          </Link>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <StatCard
            title="Current Fast"
            value={mockData.currentFast ? "Active" : "Not Fasting"}
            description={
              mockData.currentFast 
                ? `${mockData.currentFast.type} - ${mockData.currentFast.targetHours}h target`
                : "Ready to start"
            }
            icon={Timer}
          />
          ...
          <StatCard
            title="Fasting Hours"
            value={mockData.totalFastingHours}
